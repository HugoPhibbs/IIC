...
from Clustering_IIC.code.datasets.segmentation import DoerschDataset
from Clustering_IIC.code.datasets.segmentation import cocostuff
from Clustering_IIC.code.datasets.segmentation import potsdam
