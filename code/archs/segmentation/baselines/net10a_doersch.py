...
from Clustering_IIC.code.archs.segmentation.net10a import SegmentationNet10aTrunk, \
  SegmentationNet10a
from Clustering_IIC.code.utils.segmentation.baselines.general import get_patches
